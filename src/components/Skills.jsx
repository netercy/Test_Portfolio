...
const Skills = () => {
  return (
    <>
      <h2 className='font-bold text-8xl mt-80 w-full text-center md:text-6xl md:mt-32'>Skills</h2>
      <div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] lg:bg-circularLightLg lg:dark:bg-circularDarkLg md:bg-circularLightMd md:dark:bg-circularDarkMd sm:bg-circularLightSm sm:dark:bg-circularDarkSm'>
        ...
        <Skill name='Computer vision' x='-25vw' y='2vw' />
        <Skill name='Data science' x='-5vw' y='-10vw' />
        <Skill name='NLP' x='20vw' y='6vw' />
        <Skill name='DL' x='0vw' y='12vw' />
        <Skill name='RL' x='-20vw' y='-15vw' />
        <Skill name='Cognitive computing' x='15vw' y='-12vw' />
        <Skill name='TensorFlow' x='32vw' y='-5vw' />
        <Skill name='ML' x='0vw' y='-20vw' />
        <Skill name='PyTorch' x='-25vw' y='18vw' />
        <Skill name='OpenCV' x='18vw' y='18vw' />
      </div>
    </>
  );
};
